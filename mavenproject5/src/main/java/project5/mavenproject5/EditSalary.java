...
public class EditSalary extends javax.swing.JFrame {
    ...
    public EditSalary() {
        initComponents();
        jLabel1.setText(Manager_Employee.ids);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter New Salary for:");
        ...
        jLabel3.setText("Done successfully");
        ...
        try {
           ...
           if(jTextField1.getText().isEmpty()){
            ...
            int salary=0;
               ...
               catch(Exception e){ JOptionPane.showMessageDialog(null,"invaled Salary");return;}
           
            stmt.executeUpdate("Update employee set salary='"+salary+"' where ssn = "+Manager_Employee.ids);
